...
private:
  ...
  {
    const std::string baseName; sprintf(baseName, "%d", frame);
    const std::string cloudName = "cloud" + baseName + ".pcd";
    const std::string colorName = "color" + baseName + ".jpg";
    const std::string depthName = "depth" + baseName + ".png";
