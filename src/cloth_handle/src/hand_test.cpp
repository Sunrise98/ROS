...
class Circle_path{
    ...
    void gen_path(){
            ...
            for(int i=0; i<10; i++){
                ...
                br.sendTransform(tf::StampedTransform(tf::Transform(tf::Quaternion(0.0*M_PI/180.0, 0.0*M_PI/180.0, 0.0*M_PI/180.0), 
                                                                    tf::Vector3(hand_poses.right.position.x, 
                                                                                -hand_poses.right.position.y, 
                                                                                hand_poses.right.position.z)), current_time, "/desk", "/left_target"));
                try{
